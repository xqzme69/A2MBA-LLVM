...
; CHECK-NEXT: entry:
; CHECK-NEXT: [[LEFT:%[^ ]+]] = freeze i64 %lhs, !a2mba.generated ![[GENERATED:[0-9]+]]
; CHECK-NEXT: [[RIGHT:%[^ ]+]] = freeze i64 %rhs, !a2mba.generated ![[GENERATED]]
; CHECK-NEXT: [[LHS_SCALED:%[^ ]+]] = mul i64 [[LEFT]], [[SCALE:-?[0-9]+]], !a2mba.generated ![[GENERATED]]
; CHECK-NEXT: [[RHS_SCALED:%[^ ]+]] = mul i64 [[RIGHT]], [[SCALE]], !a2mba.generated ![[GENERATED]]
