...
; BOTH-NEXT: entry:
; BOTH-NEXT: [[LEFT:%[^ ]+]] = freeze i32 %lhs, !a2mba.generated
; BOTH-NEXT: [[RIGHT:%[^ ]+]] = freeze i32 %rhs, !a2mba.generated
; BOTH-NEXT: {{%[^ ]+}} = mul i32 [[LEFT]], {{-?[0-9]+}}, !a2mba.generated
; BOTH-NEXT: {{%[^ ]+}} = mul i32 [[RIGHT]], {{-?[0-9]+}}, !a2mba.generated
